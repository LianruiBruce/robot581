...
Used ChatGPT for idea,base guide code and variable naming. Write code by hand. Part of comment generated by ChatGPT for clear reading
"""
...
def main():
    ...
    # we tried use left_motor.brake(), motor.stop(). We found that when we use stop, only left motor will stop
    left_motor.hold()
    right_motor.hold()
